...
CREATE TABLE Bonus(
		WORKER_REFERENCE_ID INT,
        BONOUS_AMOUNT INT(10),
        BONOUS_DATE DATETIME,
        FOREIGN KEY (WORKER_REFERENCE_ID)
			REFERENCES Worker(WORKER_ID)
		ON DELETE CASCADE                      --  (delete child entity when same entity is deleted from patrent automatically)
);
...
INSERT INTO Title
		(WORKER_REFERENCE_ID,WORKER_TITLE,AFFECTED_FROM) VALUES
